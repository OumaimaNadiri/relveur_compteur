...
import 'package:assabil/pages/introduction/components.dart';
import 'package:assabil/pages/introduction/items_model.dart';
                  ...
                  child: PageView.builder(
                    ...
                    itemBuilder: ((context, index) {
                      return SingleChildScrollView(
                        // Ajout d'un SingleChildScrollView pour chaque page
                        child: SizedBox(
                          width: size.width,
                          height: size.height,
                          child: Column(
